...
export const profile = {
  ...
  roles: ['Software Engineer', 'AI Systems Builder', 'Cloud & Mobile Developer', 'Former Mechanical Engineer'],
  location: 'Brisbane, Australia',
  email: 'matt94317@gmail.com',
  github: 'https://github.com/matt94317',
  linkedin: 'https://www.linkedin.com/in/matthew-yu-6653b4200/',
  cvUrl: '/Matthew_Yu_CV_SoftwareEngineer.pdf',
  cvFileName: 'Matthew_Yu_CV_SoftwareEngineer.pdf',
  availability: 'Graduating Dec 2026 · open to graduate & junior software roles',
  tagline:
    'Former mechanical engineer, now building AI-powered products end to end — from a travel wardrobe app with 20K+ users to a cloud-deployed, AI-assisted vulnerability-management platform.',
  bio: [
